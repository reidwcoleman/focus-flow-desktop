  ...
  return (
    <div className="space-y-4 md:space-y-5 lg:space-y-5 pb-6 md:pb-8 lg:pb-8">
      ...
      <button
        ...
        className="w-full relative overflow-hidden rounded-xl bg-dark-bg-secondary p-4 md:p-6 shadow-dark-soft border border-orange-500/30 hover:border-orange-500/50 transition-all active:scale-[0.98] text-left"
      >
        {/* Celebration overlay */}
        ...
        <div className="relative z-10 flex items-center justify-between">
          <div className="flex items-center gap-4 md:gap-6">
            ...
            <div>
              <div className="flex items-baseline gap-2 md:gap-3 mb-1">
                <span className="text-4xl md:text-5xl lg:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-orange-400 via-red-400 to-yellow-400">
              ...
              <p className="text-sm md:text-base text-dark-text-secondary font-medium">
                Current streak
              </p>
            </div>
          </div>
          ...
          {streak.longestStreak > 0 && (
            <div className="text-right">
              <div className="inline-flex items-center gap-2 md:gap-3 px-3 md:px-4 py-2 md:py-3 rounded-lg bg-gradient-to-r from-yellow-500/20 to-orange-500/20 border border-yellow-500/30">
                ...
                <div className="text-left">
                  <div className="text-base md:text-lg font-bold text-yellow-300">
        ...
        {/* Tap hint */}
        <div className="absolute top-3 md:top-4 right-3 md:right-4 flex items-center gap-2 px-2 md:px-3 py-1 md:py-1.5 rounded-lg bg-dark-bg-tertiary/70 backdrop-blur-sm border border-orange-500/30">
      ...
      {/* XP Display Widget */}
      {xpData && (
        <div className="relative overflow-hidden rounded-xl bg-dark-bg-secondary p-4 md:p-6 shadow-dark-soft border border-yellow-500/30">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4 md:gap-6">
              ...
              <div>
                <div className="flex items-baseline gap-2 mb-1">
                  <span className="text-3xl md:text-4xl lg:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-orange-400 to-yellow-400">
                    Level {xpData.level}
                  </span>
                </div>
                <p className="text-sm md:text-base text-dark-text-secondary font-medium">
            ...
            <div className="text-right">
              ...
              <div className="text-sm md:text-base text-dark-text-muted">
          ...
          {/* Progress Bar */}
          <div className="mt-3 md:mt-4 h-2 md:h-3 bg-dark-bg-tertiary rounded-full overflow-hidden">
            <div
              className="h-full bg-gradient-to-r from-yellow-500 via-orange-500 to-yellow-500 transition-all duration-500 ease-out"
