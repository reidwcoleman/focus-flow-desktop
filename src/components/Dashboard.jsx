...
const Dashboard = ({ onOpenScanner }) => {
  ...
  return (
    <div className="space-y-4 md:space-y-5 lg:space-y-5 pb-6 md:pb-8 lg:pb-8">
      ...
      {/* Combined Streak & XP Module */}
      {xpData && (
        <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-orange-900/20 via-dark-bg-secondary to-yellow-900/20 p-4 md:p-5 shadow-dark-soft-xl border border-orange-500/30 hover:border-orange-500/50 transition-all">
          {/* Celebration overlay */}
      ...
      {/* Fallback if no XP data yet - just show streak */}
      {!xpData && (
        <button
          onClick={() => setShowStreakCalendar(true)}
          className="w-full relative overflow-hidden rounded-xl bg-gradient-to-br from-orange-900/20 via-dark-bg-secondary to-red-900/20 p-4 shadow-dark-soft border border-orange-500/30 hover:border-orange-500/50 transition-all active:scale-[0.98] text-left"
        >
          <div className="flex items-center gap-4">
            <div className="text-4xl md:text-5xl">🔥</div>
            <div className="flex-1">
              <div className="flex items-baseline gap-2 mb-1">
                <span className="text-3xl md:text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-red-400">
                  {streak.currentStreak}
                </span>
              ...
              <p className="text-sm text-dark-text-muted">Current streak • Tap to view calendar</p>
            </div>
            {streak.longestStreak > 0 && (
