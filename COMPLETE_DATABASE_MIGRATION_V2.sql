-- ========================================
-- COMPLETE DATABASE MIGRATION V2 - FIXED ORDER
-- ========================================
-- Run this to FIX the table order and constraints
...
SELECT 'SUCCESS! All tables recreated in correct order!' as status;

SELECT table_name,
       (SELECT count(*) FROM information_schema.columns WHERE table_name = t.table_name) as column_count
FROM information_schema.tables t
WHERE table_schema = 'public'
AND table_name IN ('assignments', 'calendar_activities', 'study_sessions', 'blocking_lists', 'blocking_sessions', 'scheduled_blocks')
ORDER BY table_name;

-- ========================================
-- DONE!
-- ========================================
-- All tables recreated in dependency order:
-- 1. blocking_lists (no dependencies)
-- 2. blocking_sessions (references blocking_lists)
-- 3. scheduled_blocks (references blocking_lists)
-- Now Focus Mode should work!
-- ========================================
